...
The page is `../stem-stations.html` at the **repo root**; this directory holds its data and images. See the root `CLAUDE.md` for the layout rule and the `<base href>` contract.
