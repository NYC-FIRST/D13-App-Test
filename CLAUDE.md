...
**Git repo root:** `/Users/avigoldman/nycfirst-d13.github.io`
...
```bash
git -C /Users/avigoldman/nycfirst-d13.github.io add <path>
git -C /Users/avigoldman/nycfirst-d13.github.io commit -m "..."
```
...
```bash
git -C /Users/avigoldman/nycfirst-d13.github.io add laser-maker/         # one app only
git -C /Users/avigoldman/nycfirst-d13.github.io commit -m "feat(laser-maker): ..."
```
