...
# ---------------------------------------------------------------------------
{
  ...
  echo
  # The app root itself, which serves the onboarding page. Written without a
  # trailing slash: the Webflow site edge 301s /x/ to /x before the worker
  # ever sees the rule.
  echo "${MOUNT:-/}   $MOUNT/start   200"
